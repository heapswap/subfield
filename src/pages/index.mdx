...
**Subfield is a protocol for decentralized knowledge.**

*Subfield is an ephemeral RDF graph made up of [Semantic Triples](https://en.wikipedia.org/wiki/Semantic_triple).*
